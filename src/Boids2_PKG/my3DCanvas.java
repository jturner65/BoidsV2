...
class edge{ 
	public Boids_2 p;
	public myPoint a, b;
	public edge (Boids_2 _p){this(_p,new myPoint(0,0,0),new myPoint(0,0,0));}
	public edge (Boids_2 _p, myPoint _a, myPoint _b){p = _p;a=new myPoint(_a); b=new myPoint(_b);}

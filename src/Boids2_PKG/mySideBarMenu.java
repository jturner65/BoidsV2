...
public class mySideBarMenu extends BaseBarMenu {
	...
	protected void initSideBarMenuBtns_Priv() {
		//--update UI Lib; improve handling of left-side-menu button clicks and add ability to choose mouse-over display format/data type on the fly;
		/**
		...
		setBtnData(new String[]{"Functions 1","Functions 2","Functions 3","Functions 4"}, new int[] {3,4,4,4}, 5, true, false);

		
//		guiBtnRowNames = new String[]{"Window Choice", "Row 1","Row 2","Row 3","Row 4","DEBUG"};//,"File"};
//
//		//names for each row of buttons - idx 1 is name of row
//		guiBtnNames = new String[][]{
//			new String[]{pa.winTitles[1], pa.winTitles[2]},							//display specific windows - multi-select/ always 

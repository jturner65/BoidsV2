...
/**
 * Flocking boids sim version 2.0
 * @author john turner
 */
public class Boids_2 extends PApplet{
...
//				case '"' : {((mySideBarMenu)dispWinFrames[dispMenuIDX]).guiObjs[((mySideBarMenu)dispWinFrames[dispMenuIDX]).gIDX_cycModDraw].modVal(1); break;}//increase the number of cycles between each draw to some upper bound		
	...
	public void initDispWins(){
		...
		winRectDimOpen[disp3DResIDX] =  new float[]{menuWidth+hideWinWidth, 0,width-menuWidth-hideWinWidth,height};			
...
//////////////////////////////////////////
	...
	new int[]{0,0,0,255},                                        	// disp3DResIDX = 1;
	...
	public int[] winFlagsXOR = new int[]{show3DWin,show2DWin};//showSequence,showSphereUI};
	//specify windows that cannot be shown simultaneously here
	public int[] winDispIdxXOR = new int[]{disp3DResIDX,disp2DResIDX};//dispPianoRollIDX,dispSphereUIIDX};
...
//		}
	...
	public void displayHeader() { // Displays title and authors face on screen
		...
		fill(0); text(authorString,width-75, stVal*idx++); noFill();	
	}
